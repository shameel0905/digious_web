                    ...
                    <div className="row gx-30">
                        <div className="col-xxl-12 col-lg-12">
                            ...
                            <div>
                                ...
                                <ul>
                                    <li>
                                        Account means a unique account created for You to access our Service or parts of our Service.                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Website refers to Digious Solutions, accessible from <a href="https://www.digioussolutions.com">www.digioussolutions.com</a>
                                    </li>
                                    <li>
                            ...
                            <div >
                                <h4 className="text-white">Types of Data Collected</h4>
                            </div>
                            <div >
                                <h5 className="text-white">Personal Data</h5>
                            </div>
                            <p className="mb-30">
                            ...
                            <div >
                                <h5 className="text-white">Usage Data</h5>
                            </div>
                            <p className="mb-30">
                            ...
                            <p className="mb-30">
                                WhenWe may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.
                            </p>

                            <div >
                                <h5 className="text-white">Tracking Technologies and Cookies</h5>
                            </div>
                            <p className="mb-30">
                            ...
                            <p className="mb-30">
                                Cookies can be “Persistent” or “Session” Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: <a href="https://www.privacypolicies.com/blog/cookies/">What Are Cookies?.</a>
                            </p>
                            <p className="mb-30">
                            ...
                            <div >
                                <h5 className="text-white">Use of Your Personal Data</h5>
                            </div>
                            <p className="mb-30">
                            ...
                            <div >
                                <h4 className="text-white">Disclosure of Your Personal Data</h4>
                            </div>
                            <div >
                                <h5 className="text-white">Business Transactions</h5>
                            </div>
                            <p className="mb-30">
                                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                            </p>
                            <div >
                                <h5 className="text-white">Law enforcement</h5>
                            </div>
                            <p className="mb-30">
                                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                            </p>
                            <div >
                                <h5 className="text-white">Other legal requirements</h5>
                            </div>
                            <p className="mb-30">
                            ...
                            <div >
                                <h4 className="text-white">Security of Your Personal Data</h4>
                            </div>
                            <p className="mb-30">
                            The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
                            </p>
                            <div >
                                <h4 className="text-white">Children’s Privacy</h4>
                            </div>
                            <p className="mb-30">
                            ...
                            <div >
                                <h4 className="text-white">Links to Other Websites</h4>
                            </div>
                            <p className="mb-30">
                            ...
                            <div >
                                <h4 className="text-white">Changes to this Privacy Policy</h4>
                            </div>
                            <p className="mb-30">
